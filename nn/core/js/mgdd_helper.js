...
async function showMgddBreakdownModal(lat, lon, obsDate) {
  try {
    ...
    const url = baseDomain + "?latitude=" + lat + "&longitude=" + lon + "&start_date=" + startDate + "&end_date=" + cleanEndDate + "&daily=temperature_2m_max,temperature_2m_min" + "&temperature_unit=fahrenheit" + "&timezone=GMT";
