...
const CONST_SUNFLOWER_UTF8 = '&#127803;'         // back icon for garden list
const CONST_LEAF_UTF8      = '&#127807;';        // back icon for yard list
const CONST_BOOT_UTF8      = '<span font-size:18px;>&#x1F97E;</span>';        // back icon for thru hiker
const CONST_NPC_UTF8       = '&#128100;';        // back icon for observers
const CONST_ART_UTF8       = '&#127912;';        // back icon for journaling / artwork
